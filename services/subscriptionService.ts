...
export const subscriptionService = {
    ...
    // Cancela ou reseta a assinatura: No modelo DB, apenas desloga para forçar revalidação 
    // ou poderíamos marcar no DB como cancelado se houvesse pagamento real.
    cancelSubscription: async () => {
        localStorage.removeItem('nutriplan_subscription'); // Limpa cache antigo se houver
