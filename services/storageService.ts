...
// --- MAPPERS (Garantir que os nomes das colunas no DB batam com o código) ---
...
const toDbStudent = (s: Student, userId: string) => ({
    ...
    next_appointment: s.nextAppointment,
    extra_notes: s.extraNotes,
    plan_start_date: s.planStartDate,
    plan_end_date: s.planEndDate,
...
export const storageService = {
  ...
  saveSubscription: async (sub: Subscription) => {
    ...
    await supabase.from('subscriptions').upsert({
        ...
        plan_expiration_date: sub.planExpirationDate,
        status: sub.status,
