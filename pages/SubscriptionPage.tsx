        ...
        <Layout title="Assinatura Premium">
            ...
            <div className="max-w-2xl mx-auto bg-slate-50 dark:bg-slate-900 rounded-2xl p-8 border border-slate-200 dark:border-slate-800">
                ...
                <button
                    ...
                    disabled={isLoading}
                    className={`w-full py-4 rounded-xl font-bold text-white text-lg shadow-lg flex items-center justify-center gap-2 transition-all active:scale-95 ${
                        selectedPlan === 'yearly' 
                            ...
                            <div className="flex gap-3 pt-2">
                                ...
                                <button 
                                    ...
                                    className={`flex-1 font-bold py-3.5 rounded-xl transition-all shadow-lg flex items-center justify-center gap-2 ${
                                        cancelConfirmation.toLowerCase() === 'cancelar' 
